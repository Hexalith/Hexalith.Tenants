...
public sealed class ChangeTenantMemberRoleFlowTests : BunitContext
{
    ...
    private sealed class StubTenantCommandGateway : ITenantCommandGateway
    {
        ...
        public Func<ChangeUserRoleCommandRequest, Task<TenantCommandSubmissionResult>>? ChangeRoleAsync { get; init; }

        public Func<TenantCommandTrackingHandle, Task<TenantCommandStatusResult>>? StatusAsync { get; init; }

        public ChangeUserRoleCommandRequest? LastChangeRoleRequest { get; private set; }
