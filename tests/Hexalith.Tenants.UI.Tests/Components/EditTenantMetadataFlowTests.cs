...
public sealed class EditTenantMetadataFlowTests : BunitContext
{
    ...
    private sealed class StubTenantCommandGateway : ITenantCommandGateway
    {
        ...
        public Func<UpdateTenantCommandRequest, Task<TenantCommandSubmissionResult>>? UpdateTenantSubmissionAsync { get; init; }

        public Func<TenantCommandTrackingHandle, Task<TenantCommandStatusResult>>? StatusAsync { get; init; }

        public UpdateTenantCommandRequest? LastUpdateTenantRequest { get; private set; }
