...
| H-1 stale technology reality | **Resolved** | Stack now matches central pins: .NET `10.0.301`, Fluent `5.0.0-rc.4-26180.1`, FrontComposer `3.1.1`, EventStore `3.64.1`, Memories `2.5.0`, Dapr `1.18.4`, Aspire `13.4.6`, xUnit `3.2.2`, and bUnit `2.8.4-preview`. Source SHAs are correctly treated as mutable implementation state rather than architecture invariants. |
