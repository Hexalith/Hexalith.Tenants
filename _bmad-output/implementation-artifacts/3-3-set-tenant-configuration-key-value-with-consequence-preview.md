...
- Story 3.2 is blocked by FR15 platform-wide destructive governance and should not be treated as implemented code. Its value for Story 3.3 is the explicit distinction: tenant-scoped configuration commands remain fallback-eligible while lifecycle disable/enable stays blocked. [Source: `_bmad-output/implementation-artifacts/3-2-disable-or-enable-tenant-with-high-impact-confirmation.md`]
