...
Review whether the implementation satisfies the approved spec and repository rules.

You may inspect the repository. Read these files first:

- `_bmad-output/implementation-artifacts/spec-gh-actions-28953291798-85906522208.md`
...
Then audit the diff below against the acceptance criteria, boundaries, and context docs. Return findings only when the change violates the approved intent, misses an acceptance criterion, weakens fail-closed/support-safe behavior, or violates project rules. Include severity and file/line references.
